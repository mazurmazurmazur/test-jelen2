...
function moreButton(d, m, mb, arrow) {
  var dots = document.getElementById(d);
  var moreText = document.getElementById(m);
  var btnText = document.getElementById(mb);
  var arrowRozwin = document.getElementById(arrow);
  ...
  if (dots.style.display === "none") {
    ...
    console.log("lol");
    arrowRozwin.style.transform = "rotate(0deg)";
  } else {
    ...
    /* arrowRozwin.style.transform.scaleX = -1; */
